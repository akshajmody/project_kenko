    ...
    if (this.state.renderMealPlan === true) {
      return (
        <div className="foods">
          ...
          <div className="regenerate">⠕upload optimized meal (UNDER MAINTENANCE)⠪</div>
          {/* this functionality was going to allow saving of meal plans - in creating this app further, there will be a search function that allows a user to pull up a meal plan based on ID or saved name of the meal plan - this can become somewhat of a social aspect, sharing meal plans with other users, other users can access the meal plans via a code to access from the database! */}
